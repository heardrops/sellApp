    ...
    <div class="foodInfo" v-show="showFlag" ref="foodInfo">
      <div class="food_content">
        ...
        <div class="rating">
          ...
          <ratingSelect :ratings="food.ratings" :select-type="selectType" :only-content="onlyContent" :desc="desc" @selRatings="filterRatings" @isContent="isContent"></ratingSelect>
            ...
            <ul>
              <li class="ratings_item border-1px" v-for="(ratingItem, index) in food.ratings" :key="index" v-show="needShowList(ratingItem.rateType, ratingItem.text)">
                ...
                <div class="user">
                  ...
                  <img :src="ratingItem.avatar" alt="" class="avatar" width="12" height="12">
                </div>
                <p class="text">
...
export default {
  ...
  methods: {
    ...
    addFirst(event) {
      if(!event._constructed) {//阻止pc端点击后执行2次
        return;
      }
